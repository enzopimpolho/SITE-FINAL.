...
function Conteudo({ nome, categoria, slug, descricao }: { nome: string; categoria: string; slug: string; descricao: string }) {
  return (
    <div>
      <p className="label text-fog-300">{categoria}</p>
      <p className="mt-2 text-2xl font-medium text-white md:text-4xl">{nome}</p>
      <p className="my-4 max-w-lg text-base text-fog-200">{descricao}</p>
