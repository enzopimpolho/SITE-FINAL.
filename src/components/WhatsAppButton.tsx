...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="group fixed bottom-[max(1.5rem,env(safe-area-inset-bottom))] right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(0,0,0,0.4)] transition-transform duration-300 hover:-translate-y-0.5"
    >
