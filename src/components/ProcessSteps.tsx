...
export default function ProcessSteps() {
  ...
  return (
    <div ref={ref} className="relative pl-11 lg:pl-0">
      <div className="absolute bottom-3 left-[11px] top-3 w-px bg-white/[0.12] lg:bottom-auto lg:left-0 lg:right-0 lg:top-[11px] lg:h-px lg:w-auto" />
      <motion.div
        ...
        {processSteps.map((step, index) => {
          ...
          return (
            <li key={step.title} className="relative flex flex-col gap-1.5 lg:gap-3.5">
              ...
              <p className="text-[15px] leading-relaxed text-fog-400 lg:text-[15.5px]">{step.description}</p>
            </li>
          );
        })}
      </ol>
